...
class RegisterPart2 extends StatefulWidget {
  ...
  String gender;
  RegisterPart2(
      {this.imageUrl, this.age, this.phone_no, this.gender, this.name});
...
class _RegisterPart2State extends State<RegisterPart2> {
  ...
  int age;
  _RegisterPart2State(
      {this.name, this.age, this.phone, this.gender, this.imageUrl});
  ...
  void register() async {
    if (_signupFormKey.currentState.validate()) {
      ...
      var response = await http.post(
          'https://rpk-happenings.herokuapp.com/register',
          headers: headers,
