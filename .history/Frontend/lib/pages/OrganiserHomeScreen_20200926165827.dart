...
class _OrganiserHomeScreenState extends State<OrganiserHomeScreen> {
  ...
  List<Category> data = [];
  List<EventsAndAttendees> data_line = [], pos_data = [], neg_data = [];
  ...
  void initState() {
    ...
    neg_data = [
      EventsAndAttendees(0, 100),
      EventsAndAttendees(1, 200),
      EventsAndAttendees(2, 100),
      EventsAndAttendees(3, 300),
      EventsAndAttendees(4, 250),
      EventsAndAttendees(5, 50),
      EventsAndAttendees(6, 100),
    ];
