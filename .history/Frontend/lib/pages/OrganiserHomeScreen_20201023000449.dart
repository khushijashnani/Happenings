            ...
            Container(
              child: ListView(
                children: [
                  ...
                  dataMap.length == 0 ? Container() : PieChart(
                    dataMap: dataMap,
                  ...
                  SizedBox(height: 30,),
                  widget.no_of_events == 0 ? Container() : Container(
                    height: 300,
                  ...
                  SizedBox(height: 30,),
                  data_line.length == 0 ? Container() : Container(
                    height: 300,
                    child: SingleChildScrollView(
                      scrollDirection: Axis.horizontal,
                      child: Container(
                  ...
                  SizedBox(height: 30,),
                  pos_data.length == 0 ? Container() : Container(
                    height: 300,
                    child: SingleChildScrollView(
                      scrollDirection: Axis.horizontal,
                      child: Container(
