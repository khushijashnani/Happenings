...
class _OrganiserHomeScreenState extends State<OrganiserHomeScreen> {
  ...
  void initState() {
    ...
    setState(() {
      for (int i = 0; i < labels.length; i++) {
        print(labels[i]);
        print(Type(pie_data[i]));
        dataMap[labels[i]] = double.parse(pie_data[i]);
      }
    });
    ...
    // pos_data = [
    //   Sentiment("Event1", 200),
    //   Sentiment("Event2", 150),
    //   Sentiment("Event3", 300),
    //   Sentiment("Event4", 100),
    //   Sentiment("Event5", 500),
    //   Sentiment("Event6", 500),
    //   Sentiment("Event7", 500),
    // ];
    // neg_data = [
    //   Sentiment("Event1", 100),
    //   Sentiment("Event2", 200),
    //   Sentiment("Event3", 100),
    //   Sentiment("Event4", 300),
    //   Sentiment("Event5", 250),
    //   Sentiment("Event6", 500),
    //   Sentiment("Event7", 500),
    // ];
  ...
  Widget buildBarGraph() {
    return Padding(
      ...
      child: Container(
        height: 300,
        width: data.length <= 6 ? screenWidth : screenWidth + screenWidth * ((data.length - 6) * 0.1),
        child: ShaderMask(
  ...
  Widget drawLineGraph() {
    return Container(
      height: 300.0,
      width : data_line.length <= 6 ? screenWidth : screenWidth + screenWidth * ((data_line.length - 6) * 0.1),
      child: ShaderMask(
