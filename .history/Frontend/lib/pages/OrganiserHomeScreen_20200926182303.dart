  ...
  void initState() {
    ...
    series_group = [
      charts.Series(
        ...
        data: pos_data,
        colorFn: (Sentiment sentiment, _) => charts.Color.fromHex(code : '#000C66'),
      ...
      charts.Series(
        ...
        measureFn: (Sentiment sentiment, _) => sentiment.attendees,
        data: neg_data,
        colorFn: (Sentiment sentiment, _) => charts.Color.fromHex(code : '#7EC8E3'),
        labelAccessorFn: (Sentiment sentiment, _) => "${sentiment.attendees}"
      ),
    ];
  }
        ...
        child: charts.BarChart (
            ...
            behaviors: [
              ...
              new charts.ChartTitle(
                ...
                titleOutsideJustification: charts.OutsideJustification.middleDrawArea,
                titleStyleSpec: charts.TextStyleSpec(
                  color: charts.Color.fromHex(code: '#2980B9')
                )
              ),
              new charts.ChartTitle(
                'Attendees',
