                            ...
                            child: Row(
                              children: [
                                Padding(
                                  ...
                                  child: Material(
                                    color: locations.contains("Mumbai") ? Colors.white : Colors.yellow[800],
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              "Mumbai",
                                              style: TextStyle(
                                                color: locations.contains("Mumbai") ? CARD : Colors.white, fontWeight: FontWeight.w900, fontSize: 16
                                              ),
                                            ),
                                            locations.contains("Mumbai") ?  Padding(
