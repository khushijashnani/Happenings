...
class _OrganiserHomeScreenState extends State<OrganiserHomeScreen> {
  ...
  Widget organiserCard(double bL, double bR, double tL, double tR, String top, String bottom, String alignment) {
    return Material(
      ...
      child: Container(
        alignment: alignment == "tL" ? Alignment.topLeft : alignment == "bL" ?  Alignment.topRight : alignment == "bL" ? Alignment.bottomLeft : Alignment.bottomRight,
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                SizedBox(height: 20,),
                                organiserCard(10, 10, 10, 80, "500 +", "Attendees", "bL"),
                              ],
                            ),

                            Column(
                              children: [
                                organiserCard(80, 10, 10, 10, "25", "Events", "tR"),
                                SizedBox(height: 20,),
                                organiserCard(10, 10, 80, 10, "500 +", "Attendees", "bR"),
                              ],
                            ),
                          ],
                        ),
