                      ...
                      height == 60 ? Container() : Column(
                        ...
                        children: [
                            ...
                            child: Material(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Center(child: Text("Select Date", style: TextStyle(color: Colors.blue, fontSize: 18),)),
                                ),
                              ),
                            ),
                          ),
                          ...
                          Container(
                            ...
                            child: Text("Date : "+formattedate, style: TextStyle(fontSize: 20), textAlign: TextAlign.center),
                          ),
                        ],
                      )
                    ],
