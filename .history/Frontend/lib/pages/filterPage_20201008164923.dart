                            ...
                            child: Row(
                              children: [
                                Padding(
                                  ...
                                  child: Material(
                                    color: locations.contains("Borivali") ? Colors.yellow[800] : Colors.white,
                                    borderRadius: BorderRadius.all(Radius.circular(20)),
                                    child: InkWell(
                                      borderRadius: BorderRadius.all(Radius.circular(20)),
                                      onTap: (){
                                        setState(() {
                                          if (locations.contains("Borivali")){
                                            locations.remove("Borivali");
                                          } else {
                                            locations.add("Borivali");
                                          }
                                        });
                                      },
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              "Borivali",
                                              style: TextStyle(
                                                color: locations.contains("Borivali") ? CARD : CARD, fontWeight: FontWeight.w900, fontSize: 16
                                              ),
                                            ),
                                            locations.contains("Borivali") ?  Padding(
                                              padding: const EdgeInsets.only(left: 5),
                                              child: Icon(Icons.cancel, color: CARD, size: 20,),
                                            ) : Container()
                                          ],
                                        ),
                                      ),
