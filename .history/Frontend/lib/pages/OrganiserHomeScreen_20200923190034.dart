...
class _OrganiserHomeScreenState extends State<OrganiserHomeScreen> {
  ...
  Widget organiserCard(double bL, double bR, double tL, double tR, String top, String bottom, String alignment, Icon icon) {
    return Material(
      color: CARD,
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                SizedBox(height: 20,),
                                organiserCard(10, 10, 10, 80, "35000 +", "Revenue", "bL",null),
                              ],
                            ),

                            Column(
                              children: [
                                organiserCard(80, 10, 10, 10, "1000 +", "Attendees", "tR", null),
                                SizedBox(height: 20,),
                                organiserCard(10, 10, 80, 10, "500 +", "Reviews", "bR", null),
                              ],
                            ),
                          ],
                        ),
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: AutoSizeText(
                                    ...
                                    maxLines: 2,
                                    style: TextStyle(
                                      color: YELLOW, fontStyle: FontStyle.italic, fontWeight: FontWeight.bold, fontSize: 25
                                    ),
                                  ),
                                ),
                              ),
