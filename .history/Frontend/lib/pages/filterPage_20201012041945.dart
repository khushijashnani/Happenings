                                    ...
                                    onTap: (){
                                      ...
                                      setState(() {
                                        ...
                                        for (Event e in events) {
                                          if ((!moneyFilter || (e.entryamount >= _currentRangeValues.start && e.entryamount <= _currentRangeValues.end)) && (category == "None" || e.category == category) && (locations.length == 0 || locations.contains(e.location))){
                                            if (date.isBefore(e.startDate)){
                                              temp.add(e);
                                            }
                                          }
                                        }
